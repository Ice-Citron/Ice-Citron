...
- **Vikaso Robotics — Robotics & ML Intern.** Built the company’s first calibration pipeline and integrated six segmentation / 6D pose models behind one interface for a UR5e. Developed a BOP evaluation harness to reproduce published Average Recall results.
...
- **F1 in Schools — Anduril Racing** — [Team site](https://andurilracing.com)  
